...
function preferredRelatedIds(pageId) {
  ...
  const groups = {
    ...
    "tv-no-sound": ["tv-sound-no-picture", "tv-no-signal", "tv-remote-not-working", "tv-turns-off", "digital-channels", "soundbar-to-tv", "picture-setup"],
    ...
    "picture-setup": ["viewing-distance", "tv-dimensions", "wall-planner", "tv-no-signal", "laptop-to-tv", "screen-cleaning", "phone-to-tv"],
    "soundbar-to-tv": ["tv-no-sound", "tv-no-signal", "picture-setup", "tv-sound-no-picture", "tv-remote-not-working", "smart-tv-box"],
