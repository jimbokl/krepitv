...
function preferredRelatedIds(pageId) {
  ...
  const groups = {
    ...
    "tv-model-lookup": ["tv-purchase-checklist", "vesa", "tv-mount-screws", "tv-firmware-update", "tv-app-install", "tv-wont-turn-on", "buy-tv-mount"],
    ...
    "hide-tv-wires": ["wall-planner", "mounting-map", "tv-zone-sockets", "wall-mounted-tv", "full-motion-mount", "mounting-height"],
