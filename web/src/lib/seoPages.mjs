...
function preferredRelatedIds(pageId) {
  ...
  const groups = {
    ...
    "usb-video-codec": ["tv-usb-not-seen", "tv-usb-file-system", "tv-usb-video-subtitles", "tv-audio-track-language"],
    "tv-dlna": ["laptop-to-tv", "phone-to-tv", "tv-no-internet", "smart-tv-setup"],
    "tv-usb-recording": ["digital-channels", "tv-usb-file-system", "tv-usb-not-seen", "tv-antenna-connect"],
    "tv-channel-order": ["digital-channels", "tv-antenna-connect", "digital-box-connect", "tv-remote-not-working"],
    "tv-hdmi-cec": ["soundbar-to-tv", "tv-arc-no-sound", "game-console-to-tv", "smart-tv-box"],
    "tv-airplay-failure": ["phone-to-tv", "tv-no-internet", "tv-internet-setup", "smart-tv-setup"],
    "tv-transport": ["remove-tv-from-mount", "wall-mounted-tv", "tv-purchase-checklist", "screen-cleaning"],
    "tv-cam-module": ["digital-channels", "tv-antenna-connect", "digital-box-connect", "tv-no-signal"],
    "tv-pin-reset": ["tv-factory-reset", "tv-model-lookup", "tv-remote-not-working", "tv-restart"],
    "tv-arc-no-sound": ["soundbar-to-tv", "tv-hdmi-cec", "tv-no-sound", "tv-audio-video-sync"],
    "tv-wifi-limited": ["tv-no-internet", "tv-internet-setup", "phone-hotspot", "smart-tv-setup"],
    "tv-safe-mode-exit": ["tv-restart", "tv-store-mode", "tv-freezes", "tv-factory-reset"],
    "tv-hdmi-laptop-not-detected": ["laptop-to-tv", "tv-no-signal", "hdmi-cable-checker", "tv-hdmi-overscan"],
    "tv-ten-digital-channels": ["digital-channels", "tv-antenna-connect", "digital-box-connect", "tv-no-signal"],
    "tv-pickup-point-check": ["tv-purchase-checklist", "dead-pixel-test", "tv-model-lookup", "tv-transport"],
    ...
    "tv-dark-screen": ["tv-half-screen-dark", "tv-sound-no-picture", "picture-setup", "tv-aspect-ratio", "tv-no-signal", "tv-wont-turn-on", "screen-cleaning"],
    ...
    "smart-tv-setup": ["tv-store-mode", "tv-internet-setup", "tv-alice-connect", "tv-browser-install", "tv-app-install", "tv-firmware-update", "tv-without-mount"],
    "camera-to-tv": ["dvd-to-tv", "tv-no-signal", "hdmi-cable-checker", "smart-tv-setup", "tv-hdr-enable", "selection-choose"],
    "dvd-to-tv": ["camera-to-tv", "tv-no-signal", "hdmi-cable-checker", "tv-aspect-ratio", "smart-tv-box", "smart-tv-setup"],
    "tv-browser-install": ["smart-tv-setup", "tv-internet-setup", "tv-app-install", "tv-storage-cleanup", "tv-keyboard-mouse", "tv-youtube-recovery"],
    "tv-without-mount": ["selection-choose", "wall-mounted-tv", "mobile-tv-stand", "vesa", "tv-mount-screws", "tv-installation-cost"],
    "tv-hdr-enable": ["picture-setup", "tv-game-mode", "hdmi-cable-checker", "tv-no-signal", "smart-tv-setup", "camera-to-tv"],
    "tv-over-fireplace": ["tv-over-radiator", "tv-wall-niche", "mounting-height", "wall-planner", "mounting-map", "selection-choose"],
    "tv-over-radiator": ["tv-over-fireplace", "tv-wall-niche", "wall-planner", "mounting-height", "selection-choose", "wall-mounted-tv"],
    "tv-wall-niche": ["tv-dimensions", "wall-planner", "mounting-map", "wall-mounted-tv", "selection-choose", "mounting-height"],
    "tv-without-drilling": ["mobile-tv-stand", "tv-without-mount", "selection-choose", "wall-material-check", "wall-mounted-tv", "tv-wall-fasteners"],
    "wall-material-check": ["tv-wooden-wall", "tv-wall-fasteners", "wall-mounted-tv", "mounting-map", "tv-without-drilling", "selection-choose", "tv-mount-level"],
    "tv-mount-level": ["mounting-map", "wall-mounted-tv", "selection-choose", "wall-material-check", "tv-wall-fasteners", "tv-wall-niche"],
    "tv-4k-enable": ["tv-resolution-check", "tv-120hz-enable", "tv-hdr-enable", "picture-setup", "hdmi-cable-checker", "tv-model-lookup"],
    "tv-store-mode": ["smart-tv-setup", "picture-setup", "tv-model-lookup", "tv-factory-reset", "tv-app-install", "tv-safe-mode-exit", "tv-4k-enable"],
    "tv-resolution-check": ["tv-4k-enable", "tv-120hz-enable", "tv-hdr-enable", "picture-setup", "tv-model-lookup", "hdmi-cable-checker"],
    "tv-120hz-enable": ["tv-4k-enable", "tv-resolution-check", "tv-hdr-enable", "tv-game-mode", "hdmi-cable-checker", "tv-model-lookup"],
    "tv-no-signal": ["hdmi-cable-checker", "tv-sound-no-picture", "digital-channels", "laptop-to-tv", "phone-to-tv", "tv-hdmi-laptop-not-detected", "tv-no-internet", "tv-turns-off"],
    "tv-sound-no-picture": ["tv-no-signal", "picture-setup", "tv-no-sound", "tv-turns-off", "tv-remote-not-working", "laptop-to-tv"],
    "tv-no-sound": ["tv-audio-noise", "tv-speakers", "tv-headphones", "soundbar-to-tv", "tv-sound-no-picture", "tv-no-signal", "tv-remote-not-working", "tv-turns-off"],
    ...
    "tv-no-internet": ["tv-usb-not-seen", "tv-wifi-limited", "smart-tv-box", "digital-channels", "tv-no-signal", "phone-to-tv", "laptop-to-tv", "tv-turns-off"],
    ...
    "laptop-to-tv": ["tv-no-signal", "phone-to-tv", "tv-no-internet", "tv-usb-not-seen", "tv-hdmi-laptop-not-detected", "picture-setup", "digital-channels"],
    "digital-channels": ["tv-antenna-connect", "digital-box-connect", "tv-no-signal", "tv-no-internet", "picture-setup", "tv-ten-digital-channels", "laptop-to-tv", "phone-to-tv"],
    "picture-setup": ["tv-flicker", "dead-pixel-test", "tv-game-mode", "tv-energy-consumption", "screen-cleaning", "tv-color-distortion", "tv-aspect-ratio", "tv-dark-screen", "viewing-distance", "tv-dimensions", "wall-planner", "tv-no-signal"],
    ...
    "tv-wall-gap": ["slim-tv-mount", "corner-tv-mount", "tv-device-shelf", "fixed-mount", "full-motion-mount", "tv-zone-sockets", "selection-choose"],
    ...
    "tv-purchase-checklist": ["dead-pixel-test", "hide-tv-wires", "tv-model-lookup", "vesa", "tv-mount-screws", "tv-pickup-point-check", "tv-dimensions", "wall-planner"],
    ...
    "fixed-mount": ["slim-tv-mount", "buy-tv-mount", "mount-brand-onkron", "wall-mounted-tv", "tilt-mount", "full-motion-mount", "mounting-height"],
