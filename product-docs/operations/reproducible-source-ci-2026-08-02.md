...
публикуемой копией `docs/pkg/krepitv_engine_bg.wasm`. Изменение исходников без
соответствующего проверенного production artifact не проходит gate. Публикация
остаётся отдельной операцией Pages и не входит в CI.
